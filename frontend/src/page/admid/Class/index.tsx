...
import { DeleteClassByID, GetClasses } from "../../../service/https/cruiseTrip";
                                    ...
                                    <div className="flex ml-6 pt-6 h-auto">
                                        <div className="flex flex-col items-start relative">
                                            ...
                                            <div className="absolute top-0 left-0 p-4">
                                                <h1 className="text-green mb-1 text-[26px]">{cls.ClassType.Name}</h1>
                                                <h2 className="text-green mb-2 text-[38px]">{cls.ClassName}</h2>
                                            </div>
                                            ...
                                            <h5 className="text-green mb-2 text-[20px]">By {cls.Trainer.Name}</h5>
